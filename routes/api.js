...
* ADDRESS
* */
const API_ADDRESS_URL = '/addresses';
router.get(`${API_ADDRESS_URL}/all`, addressController.index);
router.get(`${API_ADDRESS_URL}/:id`, addressController.address);
router.post(`${API_ADDRESS_URL}/add`, addressController.create);
router.post(`${API_ADDRESS_URL}/update/:id`, addressController.update);
router.delete(`${API_ADDRESS_URL}/delete/:id`, addressController.delete);
